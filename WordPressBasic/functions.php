...
function bcn_add($bcnObj)
{
	// デフォルト投稿の詳細ページかどうか
	if (is_singular('post')) {
		// 新規のtrailオブジェクトを先頭に追加する
		array_unshift($bcnObj->trail, new bcn_breadcrumb('お知らせ', null, array('post-clumn-archive'), home_url('/all-news/'), null, true));

		// トップページのtrailオブジェクトを一時的に保存
